#!/usr/bin/env python3
"""Review all candidates in Application Review stage."""
...
def review_all_candidates():
    ...
    job_id = "4779bcf4-4352-45a1-9df0-0a68c52bf27c"  # Director of Platform, India
    job_title = "Director of Platform, India"
